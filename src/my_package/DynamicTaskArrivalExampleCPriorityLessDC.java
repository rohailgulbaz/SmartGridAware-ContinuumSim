...
public class DynamicTaskArrivalExampleCPriorityLessDC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Create a broker
        DatacenterBrokerNormalFaaSCPriorityLessDC broker3 = nf.createBrokerNormalFaaSCPriorityLessDC("Broker3"); //createBroker();
