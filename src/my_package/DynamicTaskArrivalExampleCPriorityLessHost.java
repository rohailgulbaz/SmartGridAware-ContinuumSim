...
public class DynamicTaskArrivalExampleCPriorityLessHost {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int[] MIPSperHost = {
    		    ...
    		    //14000, 17000, 20000, 18000, 18000,4000, 5000, 6000, 7000, 6000,
    			//7000, 19000, 
        ...
        // Create a broker
        DatacenterBrokerNormalFaaSCPriorityLessHost broker3 = nf.createBrokerNormalFaaSCPriorityLessHost("Broker3"); //createBroker();
      ...
      //DC list for Broker: DC no. 1
		...
		/*
		List<Datacenter> SouthCentralSweden = new ArrayList<>();
		SouthCentralSweden.add(datacenter5);
		SouthCentralSweden.add(datacenter6);
		GeoRegions.add(SouthCentralSweden);
		*/
		
		List<Datacenter> NewSouthWales = new ArrayList<>();
		NewSouthWales.add(datacenter5);
		NewSouthWales.add(datacenter6);
