...
public class DynamicTaskArrivalExampleCPriorityUSA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Create a broker
        DatacenterBrokerNormalFaaSCPriorityUSA broker3 = nf.createBrokerNormalFaaSCPriorityUSA ("Broker3"); //createBroker();
      ...
      //DC list for Broker: DC no. 1
		...
		Arizona.add(datacenter5);
		GeoRegions.add(Arizona);
		
		List<Datacenter> USSouthWest = new ArrayList<>();
		USSouthWest.add(datacenter6);
		USSouthWest.add(datacenter7);
		USSouthWest.add(datacenter8);
