...
public class DynamicTaskArrivalExampleCPriorityAustraliaM {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Create a broker
        DatacenterBrokerNormalFaaSCPriorityAustraliaM broker3 = nf.createBrokerNormalFaaSCPriorityAustraliaM ("Broker3"); //createBroker();
