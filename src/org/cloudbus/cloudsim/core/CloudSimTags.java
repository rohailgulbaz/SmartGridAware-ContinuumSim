...
public class CloudSimTags {
	/** To handle dynamic Task Arrival and Container/VM creation **/
	public static final int CLOUDLET_ARRIVAL = 9999;
	
	public static final int CONTAINER_CREATE_ACK = 9998; //create containers if not already created

	public static final int JOB_FINISHED = 9997; //once a job is finished, this is called
	
	//public static final int TICK_EVENT = 9996;
