...
public class Cloudlet {
	...
	/**
	 * Cloudlet or job belongs to a specific service
	 **/
	private int Service;
	
	/**
	 * Cloudlet Eligible Pool
	 **/
	private int Pool;
	
	/**
	 * Cloudlet requires a specific RAM
	 **/
	private int RAM;
	
	/**
	 * Cloudlet requires a specific CPU
	 **/
	private int CPU;
	...
	private Vm vmObject;
	 ...
	 /**
		...
		public Cloudlet(
				...
				final int ServiceRequired,
				final int RAMrequired,
				final int CPUrequired) {
	...
	public void setSubmissionDelay(final double clockTime) {
		if (delay < 0) 
	 ...
	 * Set Service for job
	 */
	public void setService(int ServiceRequired) {
		this.Service=ServiceRequired;
	}
	 ...
	 * Set RAM for job
	 */
	public void setRAM(int RAMrequired) {
		this.RAM=RAMrequired;
	}
	 ...
	 * Set CPU for job
	 */
	public void setCPU(int CPUrequired) {
		this.CPU= CPUrequired;
	}
