...
public class Vm {
	...
	/** Busy Power Per Second derived from the Host Busy Power based on the Share of Container. */
	private double busyPower;
	
	/** Idle Power Per Second. Full Idle Power coming from the Host. */
	private double idlePower;
	
	/** DC id where VM or Container is created. */
	private int DCid;
	
	/** First Linked Cloudlet with this Container. */
	Cloudlet cl = null;
	
	public int RequestedJobs = 0;
	 ...
	 * @param mips the mips
	 * @param service associated with the container
	...
	/**
	 * Gets the service associated with the container.
	 * 
	...
	/**
	 * Sets the service associated with the container.
	 * 
	 * @param mips the new mips
	 */
	...
	/**
	 * Gets the first cloudlet of the Container.
	 * 
	 * @return cloudlet
	 * @pre $none
	 * @post $none
	 */
	public Cloudlet getFirstCloudet() {
		return cl;
	}

	/**
	 * Sets the first cloudlet of the Container.
	 * 
	 * @param cloudlet
	 */
	public void setFirstCloudet(Cloudlet c) {
		this.cl = c;
	}
	...
	/**
	 * Gets the Busy Power of Container.
	 * 
	 * @return Busy Power
	 */
	...
	/**
	 * Sets the Busy Power of Container.
	 * 
	 * @param Busy Power
	 */
	public void setBusyPower(double busyPowerC) {
		this.busyPower = busyPowerC;
	}
	
	/**
	 * Gets the Idle Power of Container.
	 * 
	 * @return Idle Power
	 */
	...
	/**
	 * Sets the Idle Power of Container.
	 * 
	 * @param Idle Power
	 */
	public void setIdlePower(double idlePowerC) {
		this.idlePower = idlePowerC;
	}
	...
	public void setDCid(int idd) {
		DCid=idd;
		//System.out.println("VM ID: " + id + ", Datacenter ID: " + DCid);
	}
