 ...
 */
public class DatacenterBrokerNormalFaaSCPriorityUSA extends SimEntity {
	...
	private static final String FILE_PATH = "Logs\\CPriorityUSAResults.csv";
	 ...
	 * @post $none
	 */
	public DatacenterBrokerNormalFaaSCPriorityUSA(String name) throws Exception {
		super(name);
...
*/
 ...
 // Add a VM to a Host
	...
	public void getDatacenterResourceInfo() {
	    ...
	    String[] regions = {"CI-DC1-DC2", "CI-DC3-DC4"}; // Add more regions dynamically if needed
	...
	//Each Broker (CSP) will have a list of DCs 
