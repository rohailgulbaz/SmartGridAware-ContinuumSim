 ...
 */
public class DatacenterBrokerNormalFaaSCPriorityAustraliaE extends SimEntity {
	...
	private static final String FILE_PATH = "Logs\\CPriorityAustraliaEResults.csv";
	 ...
	 * @post $none
	 */
	public DatacenterBrokerNormalFaaSCPriorityAustraliaE(String name) throws Exception {
		super(name);
