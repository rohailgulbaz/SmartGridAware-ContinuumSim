 ...
 */
public class DatacenterBrokerNormalFaaSCPriority extends SimEntity {
	...
	private static final String FILE_PATH = "Logs\\CPriorityNResults.csv";
	 ...
	 * @post $none
	 */
	public DatacenterBrokerNormalFaaSCPriority(String name) throws Exception {
		super(name);
...
*/
	...
	private void handleCloudletArrival(SimEvent ev) {	
	    ...
	    System.out.println("Selected Host Id: " + h.getId() + "  Selected Datacenter : "+ h.getDatacenter().getName());
	    ...
	    if(vm == null) {  
	    	...
	    	System.out.println("Sending data: " + Arrays.toString(data)); // Debugging output
 ...
 // Add a VM to a Host
	...
	public void getDatacenterResourceInfo() {
	    ...
	    String[] regions = {"CI-DC1-DC2", "CI-DC3-DC4", "CI-DC5-DC6", "CI-DC7-DC8"}; // Add more regions dynamically if needed
