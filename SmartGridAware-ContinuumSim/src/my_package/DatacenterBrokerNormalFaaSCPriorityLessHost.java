 ...
 */
public class DatacenterBrokerNormalFaaSCPriorityLessHost extends SimEntity {
	...
	private static final String FILE_PATH = "Logs\\CPriorityLessHostResults.csv";
	 ...
	 * @post $none
	 */
	public DatacenterBrokerNormalFaaSCPriorityLessHost(String name) throws Exception {
		super(name);
